...
import EditExercise from './edit-exercise.component.js';
   	...
   	return this.state.exercises.map(currentExercise => {
   		return(
            <tr>
			    ...
			    <td>
			      <Link to={"/edit/"+currentExercise._id}>edit</Link> | <a href="#" onClick={() => { this.deleteExercise(currentExercise._id) }}>delete</a>
			    </td>
			 </tr>
   		)
   	})
